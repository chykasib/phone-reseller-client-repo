    ...
    return (
        <div className="hero my-10">
            <div className="hero-content flex-col lg:flex-row-reverse">
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSSRsLmangF5pgz8J142AGmbeG7SmYHXZ91Ug&usqp=CAU" className="max-w-sm rounded-lg shadow-2xl" alt='' />
                <div className='mx-5'>
